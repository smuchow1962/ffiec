...
| Open issue | Cross-tenant collision. The RFC 6962 construction is per-tenant; a multi-tenant ledger composes per-tenant seals. v1.0 does not specify a meta-Merkle of seals; v1.1 may, if multi-tenant verification scenarios warrant it. |
